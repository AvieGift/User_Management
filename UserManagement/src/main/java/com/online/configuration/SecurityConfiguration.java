...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	private final String ROLES_QUERY = "Select u.mail, r.role from user u inner join user_role ur on(u.id = ur.user_id) "
			+ "inner join r on (ur.role_id=r.role_id=r.role_id) where u.email=?";
